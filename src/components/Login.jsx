      ...
      <section class="h-full">
        <div class="px-6 h-full text-gray-800">
          <div class="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
            <div class="p-10 flex flex-row justify-center gap-3">
            ...
            <div class="xl:ml-20 xl:w-3/12 lg:w-5/12 md:w-5/12 mb-12 md:mb-0 rounded shadow-md p-4 bg-white">
              <form>
                ...
                <div class="mb-6">
                  <input
                    type="text"
                    class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-black focus:outline-none"
                ...
                <div class="text-center lg:text-left">
                  ...
                  <p class="flex flex-col text-sm font-semibold mt-2 pt-1 mb-0">
                    Don't have an account?
                    <Link to={"/signup"}
                      href=""
                      class="text-gray-400 hover:text-black focus:text-gray-700 transition duration-200 ease-in-out"
                    >Register</Link>
