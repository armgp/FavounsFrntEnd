...
function Login(props) {
  ...
  <div class="px-6 h-full text-gray-800">
    ...
    >
      <div
        class="grow-0 shrink-1 md:shrink-0 basis-auto xl:w-5/12 lg:w-6/12 md:w-9/12 mb-12 md:mb-0 flex justify-center"
      >
              <img
          src="https://clipart.world/wp-content/uploads/2021/04/Icon-Computer-clipart-transparent.png"
      ...
      <div class="xl:ml-20 xl:w-3/12 lg:w-3/12 md:w-8/12 mb-12 md:mb-0 rounded shadow-md p-4 bg-white">
        <form>
